...
def get_config(init_mode='canonical_checkpoint'):
  ...
  # Local checkpoints: allow override via OWL_CHECKPOINT_PATH (Docker / portable setups).
  if init_mode == 'canonical_checkpoint_local':
    env_path = os.environ.get('OWL_CHECKPOINT_PATH')
    if env_path:
